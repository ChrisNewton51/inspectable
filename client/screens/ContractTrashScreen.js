...
const ContractTrashScreen = ({user, deleteContract, contractNotTrash, emptyContractTrash}) => {

    const navigation = useNavigation();
    const dispatch = useDispatch();
    const {trash} = useSelector(state => state.contractList)
    const conts = user.contracttrash
    ...
    const onRefresh = React.useCallback(() => {
        setRefreshing(true);
        dispatch(getUserContTrash(conts))
                ...
                <View style={styles.headerPopup}>
                    ...
                    <View style={styles.headerPopupRow}>
                        <TouchableOpacity 
                            ...
                            onPress={() => {
                                contractNotTrash(contractId, user.id, user)
                                setSelect()
                                setOpenModal(false);
                                setRefreshing(true);
                                dispatch(getUserContTrash(conts))
                        ...
                        <View style={styles.confirmTrash}>
                            ...
                            <View style={styles.confirmButtons}>
                                <TouchableOpacity 
                                    ...
                                    onPress={() => {
                                        deleteContract(contractId, user.id, user)
                                        setSelect()
                                        confirmTrash(false);
                                        setOpenModal(false);
                                        setRefreshing(true);
                    ...
                    <View style={styles.confirmTrash}>
                        ...
                        <View style={styles.confirmButtons}>
                            <TouchableOpacity 
                                style={styles.confirmButton}
                                onPress={() => {
                                    emptyContractTrash(user.id, user)
                                    setSelect()
                                    confirmEmpty(false);
                                    setOpenModal(false);
                                    setRefreshing(true);
...
const mapDispatchToProps = { deleteContract, contractNotTrash, emptyContractTrash }
